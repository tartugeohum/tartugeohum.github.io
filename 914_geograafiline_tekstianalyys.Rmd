...
```{r london, echo=F, fig.align="center", fig.cap="Londoni kujutamine kirjanduses [@Heuseretal2016]", out.width="80%"}
...
```{r london2, echo=F, fig.align="center", fig.cap="Londoni kujutamine kirjanduses [@Heuseretal2016]", out.width="80%"}
knitr::include_graphics(here::here("imgs", "14_london2.PNG"))
```  
...
```{r mappinglakes3567, echo=F, fig.align="center", fig.cap="Kohtadest kirjutamine ja maastikud [@Murrieta-Flores2017]", out.width="50%"}
knitr::include_graphics(here::here("imgs", "14_costsurface.png"))
```
...
Katsetame tekstikatkenditel automaatset nimetuvastust näiteks [Dandelioniga](https://dandelion.eu/), [displaCyga](https://demos.explosion.ai/displacy-ent), [TextAnalysisOnline](https://textanalysisonline.com/spacy-named-entity-recognition-ner) vm tööriistaga, mis nimetuvastuse funktsioone sisaldab.  
...
```{r nominatim, echo=F, fig.align="center", fig.cap="Batch Nominatim geocoder", out.width="70%"}
knitr::include_graphics(here::here("imgs", "14_nominatim_geocoder.png"))
```
...
```{r counpoints, echo=F, fig.align="center", fig.cap="Korduvate punktide kokkulugemine", out.width="50%"}
...
```{r counpoints2, echo=F, fig.align="center", fig.cap="Korduvate punktide kokkulugemine ilma uut kihti tekitamata", out.width="50%"}
