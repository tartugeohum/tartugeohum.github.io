...
Teiste lihtsamate statistiliste meetodite kasutamise kohta vektorandmetega (nt lähikeskuste leidmine jm) saad lugeda [siit](https://docs.qgis.org/3.28/en/docs/user_manual/processing_algs/qgis/vectoranalysis.html).  
