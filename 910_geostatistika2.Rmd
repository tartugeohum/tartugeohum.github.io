...
<!--KDE võtab mingi nähtuse esinemissageduse ning muudab selle tiheduseks, aga ei ennusta tihedust punktide vahel, vaid ainult iseloomustab seda. Kuna interpoleerimine aga ennnustab, siis on tegu ka keerukama meetodiga.-->
...
- Esmalt tuleb kasutuse osakaalude CSV-tabel liita kihelkondade ruumiandmetega (NB! Kontrolli kihelkondade nimesid, vt \@ref(kontrollikihelkondi)).  
- Kuna interpoleerimiseks vajame punkte, mitte polügoone, siis tuleb need seejärel leida osakaaludega kihelkondade kihi põhjal. Selleks leiame kihelkondade keskpunktid ehk **tsentroidid** (**`Vector → Geometry Tools → Centroids`**).   
...
<!--- Mida suuremaks muuta IDWs kauguse koefitsiendi väärtust, seda olulisemaks saab AINULT kõige lähema punkti väärtus, mis on tegelikult täpselt sama asi, mida teevad Voronoi polügoonid: mingile alale määratakse tema kõige lähema vaatluse väärtus.--->
