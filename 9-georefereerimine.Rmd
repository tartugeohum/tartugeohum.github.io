...
Avame QGISi. QGISis on georefereerimise tööriist *Georeferencer* leitav ülevalt menüüst *Raster* alt. Juhul, kui seal valikut *Georeferencer* ei ole (näiteks kui kasutad vanemat QGISi versiooni), siis tuleb see aktiveerida. Selleks vali *Plugins → Manage and Install Plugins* → otsingusse kirjuta *Georeferencer* → tee linnuke *Georefencer GDAL Plugin* ette ja sulge see aken. Nüüd on tööriist *Georeferencer* rastrimenüü all näha. Tööriista sisselülitamine on ühekordne tegevus, järgmisel korral QGISi avades on see juba olemas. Selle tööriista kohta saab täpsemalt lugeda [QGIS 3.22 juhendist](https://docs.qgis.org/3.22/en/docs/user_manual/working_with_raster/georeferencer.html).
...
- *Linear* algoritm sobib põhliselt siis, kui tegu on kõrge kvaliteediga rasterkaardiga, mille koordinaatide referentssüsteem on teada. See ei võimalda kujutist pöörata ega muul moel muundada. Enamasti sobib see seega uuematele kaartidele, mis on (kindlas projektsioonis) suure täpsusega.     
