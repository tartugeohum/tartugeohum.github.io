...
knitr::include_graphics(here::here("imgs", "4_qgis.png"))
```
...
Saame aluskaarte kasutada ka **pistikprogrammide** kaudu (nt **QuickMapServices**, aga vt ka [teisi aluskaartide pistikprogramme](https://plugins.qgis.org/plugins/tags/basemap/?order=desc&sort=downloads)).
