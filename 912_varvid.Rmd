...
2. Valime välja ühe valla, millest soovime kaarti teha, ja teeme sellest eraldi kihi.  
3. Värvime valla polügoonid vastavalt mingile tunnusele andmestikus. Katsetame erinevaid visualiseerimisviise.    


Nagu silte, saab igale kihi elemendile lisada ka graafikuid. Lisame sektordiagrammi, mis näitab, kuidas mälestised igas uuritava valla asustusüksuses liigiti jagunevad. Selleks   

- klikime tööriistal *Layer Diagram Options*,  
...
- Lisame sildid ainult nendele küladele, kust on vähemalt 11 mälestist: *Value* kasti kirjutame avaldise `if("kokku" > 10, "ANIMI", NULL)`.  
...
- Seejärel lisame trükivaatesse uue kaardi tervest Eesti alast, ilma et Hiiumaa kiht näha oleks.  
...
- Tartu linna [kalmistud](https://geohub.tartulv.ee/maps/yp2040-miljoo-muinsuskaitse-avaandmed/about) (polügoonid) ja [kalmistutele maetud kultuurilooliste isikud](https://geohub.tartulv.ee/maps/ka-malestis/about) (polügoonid),  
...
- Tartu linna [rahvastiku ja eluruumide prognoos](https://geohub.tartulv.ee/maps/yp2040-ruumiline-areng-avaandmed/about) (polügoonid),  
...
Ülesanne on mõelda välja üks või paar teemat, mida andmete põhjal saaks kaardil kujutada ning kujundada üks kaart nii, et andmed oleksid esitatud **võimalikult hästi** ja täpselt, võttes arvesse nii vajalikke/ebavajalikke elemente, skaalasid, värve jm-d, ja teine kaart nii, et andmed oleksid esitatud **halvasti ja eksitavalt**. Selleks, et tekiksid konkreetsed võrdlusalused, võiks esmalt paaris kokku leppida, mis elementidega mängitakse ja mis põhimõtetel andmeid esitatakse.  

Lubatud (mõnel juhul isegi soovitatud) on andmetest vaid mingite alamhulkade kujutamine, samuti võib muuta kihi ruumikujusid (näiteks väikeste polügoonide asemel kujutada nende polügoonide keskpunkte või punktide asemel kujutada polügoonidena nendesse jäävate punktide arvu).  

Praktikumi lõpus tutvustage paar minutit enda andmeid ja kaarte.  


## Järgmisel korral

Maailma ruumiandmed ja diagrammid.