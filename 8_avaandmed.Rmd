...
Kus asuvad Tartus suuremate kortermajadega piirkonnad? Vaatame faili *tartuaadressid.csv* (Moodle'is), mis on alamosa Maa-ameti [jõusolevate aadressiobjektide andmestikust](https://xgis.maaamet.ee/adsavalik/extracts) (seisuga 5.09.2022). Kuna Tartu aadresside algfail on üpris suur (97 255 kirjet), siis meie kasutatav fail sisaldab ainult elukondlike hoonete ja eluruumide aadresse, millel on olemas ka koordinaadid.  
...
- Lisame aadressiandmed:  
  ...
  - Jälgime, et kodeering (*Encoding*) oleks "UTF-8", väljade eraldajaks (*delimiter*) oleks valitud tabulaator (*Tab*), teeme linnukesed kastidesse *First record has field names* ja *Detect field types*, valime punktide koordinaatideks vastavalt tulbad *VIITEPUNKT_X* ja *VIITEPUNKT_Y* ning määrame koordinaatide referentssüsteemiks EPSG:3301.     
...
- Määrame aadressiobjektide punktide suuruseks 1 mm, eemaldame neilt välimise ringjoone ning määrame nende väljapaistvusprotsendiks 5%:  
...
knitr::include_graphics(here::here("imgs", "7_tartukortermajad.png"))
```


#### Ülesanne 1

Salvesta loodud kaart pildifailina. Lisa juurde mõõtkava, kaardi pealkiri ning viide kasutatud andmetele. Laadi tehtud kaart Moodle'isse üles.  
...
Teeme kaardirakenduses pildil näidatud parameetritega teemakaardi murdekõnelejate hulgast Eesti asustusüksustes (2011. aasta rahvaloenduse tulemuste põhjal). Jätame läbipaistvusele, väärtusvahemikele ja värviskaalale nende vaikeväärtused. Kaardi laadimine võib pisut aega võtta.   


```{r statamet, echo=F, fig.show='hold', fig.align='center', out.width= "30%", fig.cap = "Ükskõik millise murde kõnelejate kuvamine Statistikaameti teemakaardil (1)"}
knitr::include_graphics(here::here("imgs", "8_statamet.PNG"))
```

```{r statamet2, echo=F, fig.show='hold', fig.align='center', out.width= "80%", fig.cap = "Ükskõik millise murde kõnelejate kuvamine Statistikaameti teemakaardil (2)"}
...
Uuri, kuidas on maakondades 2021. aasta rahvaloenduse põhjal rahvaarv 2011. aasta andmetega võrreldes **protsentuaalselt** kõige rohkem muutunud. Selleks  

- laadi QGISi Maa-ameti [maakonnapiiride vektorkiht](https://geoportaal.maaamet.ee/docs/haldus_asustus/maakond_shp.zip?t=20221001010945) ja Moodle'is olev CSV-andmestik Statistikaameti [andmetega](https://andmed.stat.ee/et/stat/rahvaloendus__rel_vordlus__rahvastiku_paiknemine/RLV003) (NB! Statistikaameti andmetes ei ole koordinaate!);  
- lisa Statistikaameti andmestikku uus tulp nimega **Muutus**, kus kajastad 2021. aasta ja 2011. aasta vahet (kui rahvaarv kasvas, siis on väärtus positiivne, kui kahanes, siis negatiivne), ning teine tulp nimega **MuutusProp**, kus kajastad muutust protsentuaalselt ehk jagad tulba *Muutus* väärtused läbi 2011. aasta rahvaarvuga ja korrutad saadud tulemuse 100-ga.  

```{r addfields, echo=F, fig.show='hold', fig.align='center', out.width= "80%", fig.cap = "Tunnuste lisamine Statistikaameti tabelisse"}
knitr::include_graphics(here::here("imgs", "8_yl2.gif"))
```  
...
- [Eesti ajaloolised administratiivpiirid 20. sajandil](https://archive.org/details/HistoricalAdministrativeBordersOfEstonia) - piirid erinevad veidi Maa-ameti lehel esitatud piiridest.   
